...
MiniMasonry.prototype.init = function (t) {
  ...
  var t;
  return t = this.conf.surroundingGutter ? (this._width - this.conf.gutterX) / this._count - this.conf.gutterX : (this._width + this.conf.gutterX) / this._count - this.conf.gutterX, t = Number.parseInt(t.toFixed(2))
  ...
  function executeBlockCode(block) {
    ...
    function openGallery(article) {
      ...
      if (
        ...
        $galleryModal.insertAdjacentHTML(
          "beforeend",
          '<div class="gallery-modal__close">Close <span>✕</span></div>',
        );
      }
